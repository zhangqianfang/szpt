...
<script>
  ...
  export default {
    data() {
      return {
        titleName: { name: "学校平均共同开发教材数" },
        titleName1: { name: "" },
        headerData: { name: "学校平均共同开发教材数" },
        totalNum: '',
        xData: [],
        yData: [],
        paginationShow: true,
    ...
    mounted: function () {
      http.api({
        ...
        successCallback: function (data) {
          let {xData, yData} = getXyDataByDivision(data.workTableDate,'T_SCHOOL_CITY','TREPORTDATA35_VALUE8','T_SCHOOL_ID',1);
      ...
      getGridInfo: function (cityName,page={currentPage: 1}) {
        ...
        http.api({
          ...
          successCallback: function (data) {
            ...
            this.tableList.tbody = getNeedGridInfo(data.workTableDate,"TREPORTDATA1_VALUE2","TREPORTDATA1_VALUE1","TREPORTDATA35_VALUE8")

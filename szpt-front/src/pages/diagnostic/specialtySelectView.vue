...
<script>
  ...
  export default {
    data() {
      return {
        titleName: {name: "专业选择机制可视化分析"},
        titleName1: {name: ""},
        headerData: {name: "专业选择机制可视化分析"},
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
    ...
    mounted: function () {
      http.api({
        ...
        successCallback: function (data) {
          let {xData, yData} = getXyData(data.workTableDate, 'T_SCHOOL_CITY', 'TREPORTDATA29_VALUE4');
          this.xData = xData;
          this.yData = yData;
      ...
      http.api({
        ...
        params: this.getParams("T_SCHOOL_PROVINCE", defaultValue.provinceName),
        successCallback: function (data) {
          let {xData, yData} = getXyData(data.workTableDate, 'T_SCHOOL_PROVINCE', 'TREPORTDATA29_VALUE4');
    ...
    methods: {
      ...
      getGridInfo: function (cityName) {
        ...
        http.api({
          url: this.global.japApiPath + '/majorCon_majorSettingNum_infoList',
          params: {
            "limit": 0,
            "filters": [
              {
          ...
          successCallback: function (data) {
            this.tableList.tbody = getNeedGridInfo(data.workTableDate, "TREPORTDATA29_VALUE4", "TREPORTDATA29_VALUE5", "TREPORTDATA29_VALUE3")
          }.bind(this)
        })
      }
    },

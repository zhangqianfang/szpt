...
<script>
  ...
  export default {
    data() {
      return {
        titleName: { name: "学费收入在总收入中占比" },
        titleName1: { name: "" },
        headerData: { name: "学费收入在总收入中占比" },
        totalNum: '',
        xData: [],
        yData: [],
        paginationShow: true,
    ...
    mounted: function () {
      http.api({
        ...
        successCallback: function (data) {
          let {xData, yData} = getXyDataByDivision(data.workTableDate,'T_SCHOOL_CITY','TREPORTDATA17_VALUE15','TREPORTDATA17_VALUE1', 100);
    ...
    methods: {
      ...
      getGridInfo: function (cityName,page={currentPage: 1}) {
        ...
        http.api({
          ...
          this.tableList.tbody = getNeedGridByDivision(data.workTableDate,'TREPORTDATA1_VALUE1', 'TREPORTDATA1_VALUE2', 'TREPORTDATA17_VALUE15', 'TREPORTDATA17_VALUE1', 100)

...
export default {
  ...
  methods: {
    ...
    initChart(){
      this._defaultQuery('/socialWork_technicalMonopolyFFT_echart', {limit:"100"}, (data)=>{
    ...
    initTable(cityName, page = {pageNo:1,limit:this.page.pageSize}){
      ...
      this._defaultQuery('/socialWork_technicalMonopolyFFT_detail', option, (data)=>{

<!--高级职称教师占专任教师比例-->
<template>
  <div id="seniorTitleFullTimeTeacherRateDiv">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="seniorTitleFullTimeTeacherRateEcharts"
...
<script>
  ...
  export default {
    data() {
      return {
        titleName: {name: "高级职称教师占专任教师比例"},
        titleName1: {name: ""},
        headerData: {name: "高级职称教师占专任教师比例"},
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
          thead: ["学校代码", "学校名称", "高级职称教师占专任教师比例"],
          tbody: []
        },
      };
    },
              ...
              "filters": [
                {
                  ...
                  "tableName": "",
                  "tableColumn": "TREPORTDATA19_VALUE13",
                  "listFilter": defaultValue.seniorTitleTeacher,
                  "tableType": "7",
                  "inOrNot": "0"
                }
              ]
...
<style lang="scss" scoped>
  #seniorTitleFullTimeTeacherRateDiv {
    .receipts_left {

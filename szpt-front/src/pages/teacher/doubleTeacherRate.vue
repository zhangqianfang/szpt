  ...
  <div id="doubleTeacherRateDiv">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="doubleTeacherRateEcharts"
...
<script>
  ...
  export default {
    data() {
      return {
        titleName: {name: "\"双师型\"教师占专业教师比例"},
        titleName1: {name: ""},
        headerData: {name: "\"双师型\"教师占专业教师比例"},
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
          thead: ["学校代码", "学校名称", "\"双师型\"教师占专业教师比例"],
          tbody: []
        },
      };
    },
          ...
          "filters": [
            {
              ...
              "listFilter": defaultValue.isProfessionalTeacher,
              "tableType": "1",
              "inOrNot": "0"
            }
          ]
              ...
              "filters": [
                {
                  ...
                  "listFilter": defaultValue.isDoubleTeacher,
                  "tableType": "1",
                  "inOrNot": "0"
                }
              ]

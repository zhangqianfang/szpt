<!--专业教师占专任教师比例-->
<template>
  <div id="professionalTeacherRateDiv">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="professionalTeacherRateEcharts"
...
<script>
  ...
  export default {
    data() {
      return {
        titleName: {name: "专业教师占专任教师比例"},
        titleName1: {name: ""},
        headerData: {name: "专业教师占专任教师比例"},
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
          thead: ["学校代码", "学校名称", "专业教师占专任教师比例"],
          tbody: []
        },
      };
    },

  ...
  <div id="fullTimeTeacherNumDiv">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="fullTimeTeacherNumEcharts"
...
<script>
  ...
  export default {
    data() {
      return {
        titleName: {name: "校内专任教师总数"},
        titleName1: {name: ""},
        headerData: {name: "校内专任教师总数"},
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
          thead: ["学校代码", "学校名称", "专任教师总数"],
          tbody: []
        },
      };
    },

  ...
  <div id="partTimeTeacherRateDiv">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="partTimeTeacherRateEcharts"
              ...
              http.api({
                ...
                successCallback: function (data) {
                  ...
                  http.api({
                    ...
                    params: this.getParams("T_SCHOOL_PROVINCE", defaultValue.provinceName),
                    successCallback: function (data) {
                      var data4 = getXyData2(data.workTableDate, 'T_SCHOOL_CITY', 'COUNT1');
                      let yyData = [];
                      for (var i = 0; i < data1.xData.length; i++) {
                        if ((index = data4.xData.indexOf(data1.xData[i])) > -1) {
                          yyData.push((100 * parseInt(data1.yData[i]) / parseInt(data4.yData[index])).toFixed(2));
                        } else {
                          yyData.push(0);
                        }
                      }
                      ...
                      this.totalNum = (100 * data1.yData.reduce((acc, value) => acc + parseInt(value), 0) / data4.yData.reduce((acc, value) => acc + parseInt(value), 0)).toFixed(2);
                    }.bind(this)
                  })
                ...
                http.api({
                  ...
                  successCallback: function (data) {
                    ...
                    http.api({
                      ...
                      successCallback: function (data) {
                        var array4 = getNeedGridInfo2(data.workTableDate, "T_SCHOOL_SCHOOL_CODE", "T_SCHOOL_SCHOOL_NAME", 'COUNT1')

                        step1:for (var i = 0; i < array1.length; i++) {
                          for (var j = 0; j < array4.length; j++) {
                            if (array1[i].name == array4[j].name && array1[i].name == array4[j].name) {
                              array1[i].value = (array1[i].value * 100 / array4[j].value).toFixed(2);
                              continue step1;
                            }
                          }
                          array1[i].value = 0;

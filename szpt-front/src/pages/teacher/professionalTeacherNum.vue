<!--校内专业教师总数-->
<template>
  <div id="professionalTeacherNumDiv">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="professionalTeacherNumEcharts"
...
<script>
  ...
  export default {
    data() {
      return {
        titleName: {name: "校内专业教师总数"},
        titleName1: {name: ""},
        headerData: {name: "校内专业教师总数"},
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
          thead: ["学校代码", "学校名称", "专业教师总数"],
          tbody: []
        },
      };
    },
    mounted: function () {
      http.api({
        ...
        successCallback: function (data) {
          ...
          this.totalNum = yData.reduce((acc, value) => acc + parseInt(value), 0);
        }.bind(this)
      })
    },
    methods: {

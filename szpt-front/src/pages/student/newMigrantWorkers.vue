  ...
  <div id="allDaySchool">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="newMigrant" @chartsClick="chartsClick"></BarCharts>
      </div>
    </div>
...
<script>
  ...
  export default {
    data() {
      return {
        titleName: { name: "新型职业农名人数" },
        titleName1: { name: "" },
        headerData: { name: "新型职业农名人数" },
        totalNum: '',
        xData: [],
        yData: [],
        yDataString: '0',
    ...
    mounted: function () {
      http.api({
        ...
        successCallback: function (data) {
          let {xData, yData} = getXyData(data.workTableDate,'T_REGION_CITY_NAME','TREPORTDATA5_VALUE4');
          this.xData = xData;
          this.yData = yData;
          this.yDataString = JSON.stringify(yData);
      ...
      getGridInfo: function (cityName,page={currentPage: 1}) {
        ...
        http.api({
          ...
          successCallback: function (data) {
            ...
            this.tableList.tbody = getNeedGridInfo(data.workTableDate,"TREPORTDATA1_VALUE2","TREPORTDATA1_VALUE1","TREPORTDATA5_VALUE4")

...
<script>
  ...
  export default {
    data() {
      return {
        titleName: { name: "应届毕业生就业率" },
        titleName1: { name: "" },
        headerData: { name: "应届毕业生就业率" },
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
    ...
    mounted: function () {
      http.api({
        ...
        successCallback: function (data) {
          let {xData, yData} = getXyDataByDivision(data.workTableDate,'T_SCHOOL_CITY','TREPORTDATA37_VALUE6','TREPORTDATA37_VALUE5');
          this.xData = xData;
          this.yData = yData;
      ...
      getGridInfo: function (cityName, page={currentPage: 1}) {
        ...
        http.api({
          ...
          successCallback: function (data) {
            ...
            this.tableList.tbody = getNeedGridByDivision(data.workTableDate,'TREPORTDATA1_VALUE2', 'TREPORTDATA1_VALUE1', 'TREPORTDATA37_VALUE6', 'TREPORTDATA37_VALUE5')

  ...
  <div id="appReceipts">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="loaclVocational" @chartsClick="chartsClick"></BarCharts>
      </div>
    </div>
...
<script>
  ...
  export default {
    data() {
      return {
        titleName: { name: "内地中职班学生数" },
        titleName1: { name: "" },
        headerData: { name: "内地中职班学生数" },
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
    ...
    mounted: function () {
      http.api({
        ...
        successCallback: function (data) {
          let {xData, yData} = getXyData(data.workTableDate,'T_REGION_CITY_NAME','TREPORTDATA5_VALUE13');
          this.xData = xData;
          this.yData = yData;
      ...
      getGridInfo: function (cityName,page={currentPage: 1}) {
        ...
        http.api({
          ...
          successCallback: function (data) {
            ...
            this.tableList.tbody = getNeedGridInfo(data.workTableDate,"TREPORTDATA1_VALUE2","TREPORTDATA1_VALUE1","TREPORTDATA5_VALUE13")

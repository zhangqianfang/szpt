...
<script>
  ...
  export default {
    data() {
      return {
        titleName: { name: "全日制中职学历教育在校生总数" },
        titleName1: { name: "" },
        headerData: { name: "全日制中职学历教育在校生总数" },
        totalNum: '',
        xData: [],
        yData: [],
        paginationShow: true,
    ...
    mounted: function () {
      http.api({
        ...
        successCallback: function (data) {
          let {xData, yData} = getXyData(data.workTableDate,'T_REGION_CITY_NAME','TREPORTDATA5_VALUE2');
      ...
      getGridInfo: function (cityName,page={currentPage: 1}) {
        ...
        http.api({
          ...
          successCallback: function (data) {
            ...
            this.tableList.tbody = getNeedGridInfo(data.workTableDate,"TREPORTDATA1_VALUE2","TREPORTDATA1_VALUE1","TREPORTDATA5_VALUE2")

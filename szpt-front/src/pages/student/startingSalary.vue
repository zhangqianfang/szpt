...
<script>
  ...
  import {getXyDataByDivision, getNeedGridInfo,getGridParams} from '../../utils/common';
  import BarCharts from '../../components/barCharts';
  export default {
    data() {
      return {
        titleName: { name: "平均起薪线" },
        titleName1: { name: "" },
        headerData: { name: "平均起薪线" },
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
          thead: ["学校名称","学校代码","平均起薪线"],
          tbody: []
        },
        paginationShow: true,
        page: {
    ...
    mounted: function () {
      http.api({
        ...
        successCallback: function (data) {
          let {xData, yData} = getXyDataByDivision(data.workTableDate,'T_SCHOOL_CITY','TREPORTDATA37_VALUE16','T_SCHOOL_ID',1);
          this.xData = xData;
          this.yData = yData;
      ...
      getGridInfo: function (cityName,page={currentPage: 1}) {
        ...
        http.api({
          ...
          successCallback: function (data) {
            ...
            this.tableList.tbody = getNeedGridInfo(data.workTableDate,'TREPORTDATA1_VALUE2', 'TREPORTDATA1_VALUE1', 'TREPORTDATA37_VALUE16')

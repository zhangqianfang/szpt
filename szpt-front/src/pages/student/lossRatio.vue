  ...
  <div id="allDaySchool">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="lossRatio" @chartsClick="chartsClick"></BarCharts>
      </div>
    </div>
...
<script>
  ...
  import {getXyDataByDivision, getNeedGridByDivision, getGridParams} from '../../utils/common';
  ...
  export default {
    ...
    mounted: function () {
      http.api({
        url: HTTP_ROOT + '/api/jap/LossRatio',
        successCallback: function (data) {
          let {xData, yData} = getXyDataByDivision(data.workTableDate,'T_REGION_CITY_NAME','TREPORTDATA63_VALUE3','TREPORTDATA63_VALUE2');
          this.xData = xData;
          this.yData = yData;
    ...
    methods: {
      ...
      getGridInfo: function (cityName, page={currentPage: 1}) {
        ...
        http.api({
          url: HTTP_ROOT + '/api/jap/LossRatioGrid',
          params: getGridParams('T_REGION_CITY_NAME',cityName, page.currentPage),
          successCallback: function (data) {
            this.page.total = parseInt(JSON.parse(data.pageInfo)[0][0].value)
            this.tableList.tbody = getNeedGridByDivision(data.workTableDate,'TREPORTDATA1_VALUE2', 'TREPORTDATA1_VALUE1', 'TREPORTDATA63_VALUE3', 'TREPORTDATA63_VALUE2')

<!--目录外专业数-->
<template>
  <div id="outDirectoryMajorNumDiv">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="outDirectoryMajorNumEcharts"
...
<script>
  ...
  export default {
    data() {
      return {
        titleName: {name: "目录外专业数"},
        titleName1: {name: ""},
        headerData: {name: "目录外专业数"},
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {

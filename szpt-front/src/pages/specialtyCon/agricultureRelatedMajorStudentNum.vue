<!--涉农专业在校生数-->
<template>
  <div id="agricultureRelatedMajorStudentNumDiv">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="agricultureRelatedMajorStudentNumEcharts"
...
<script>
  ...
  export default {
    data() {
      return {
        titleName: {name: "涉农专业在校生数"},
        titleName1: {name: ""},
        headerData: {name: "涉农专业在校生数"},
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
          thead: ["学校代码", "学校名称", "在校生数"],
          tbody: []
        },
      };
    },
    mounted: function () {
      http.api({
        url: HTTP_ROOT + '/api/jap/majorCon_majorStudentNum_city',
        params: {
          "limit": 0,
          "filters": [
            {
        ...
        successCallback: function (data) {
          var object1 = getXyData2(data.workTableDate, 'T_SCHOOL_CITY', 'TREPORTDATA29_VALUE10');
          http.api({
            url: HTTP_ROOT + '/api/jap/majorCon_majorStudentNum_city',
            params: {
              "limit": 0,
            ...
            successCallback: function (data) {
              let object2 = getXyData2(data.workTableDate, 'T_SCHOOL_CITY', 'TREPORTDATA29_VALUE10');
    ...
    methods: {
      ...
      getGridInfo: function (cityName) {
        ...
        http.api({
          url: HTTP_ROOT + '/api/jap/majorCon_majorStudentNum_school',
          params: {
            "limit": 0,
            "filters": [
              {
          ...
          successCallback: function (data) {
            var array1 = getNeedGridInfo(data.workTableDate, "T_SCHOOL_SCHOOL_CODE", "T_SCHOOL_SCHOOL_NAME", "TREPORTDATA29_VALUE10")
            http.api({
              url: this.global.japApiPath + '/majorCon_majorStudentNum_school',
              params: {
                "limit": 0,
                "filters": [
                  {
              ...
              successCallback: function (data) {
                var array2 = getNeedGridInfo(data.workTableDate, "T_SCHOOL_SCHOOL_CODE", "T_SCHOOL_SCHOOL_NAME", "TREPORTDATA29_VALUE10")
...
<style lang="scss" scoped>
  #agricultureRelatedMajorStudentNumDiv {
    .receipts_left {

<!--国控专业在校生数-->
<template>
  <div id="stateControlMajorStudentNumDiv">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="stateControlMajorStudentNumEcharts"
...
<script>
  ...
  export default {
    data() {
      return {
        titleName: {name: "国控专业在校生数"},
        titleName1: {name: ""},
        headerData: {name: "国控专业在校生数"},
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
...
<style lang="scss" scoped>
  #stateControlMajorStudentNumDiv {
    .receipts_left {

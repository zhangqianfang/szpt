<!--目录外专业在校生数-->
<template>
  <div id="outDirectoryMajorStudentNumDiv">
    ...
    <div class="receipts_left">
      ...
      <div class="work_map">
        ...
        <BarCharts :x-data="xData" :y-data="yData" echart-id="outDirectoryMajorStudentNumEcharts"
...
<script>
  ...
  export default {
    data() {
      return {
        titleName: {name: "目录外专业在校生数"},
        titleName1: {name: ""},
        headerData: {name: "目录外专业在校生数"},
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
    ...
    mounted: function () {
      http.api({
        ...
        successCallback: function (data) {
          ...
          this.xData = xData;
          this.yData = yData.reduce(function (acc, value) {
...
<style lang="scss" scoped>
  #outDirectoryMajorStudentNumDiv {
    .receipts_left {

...
<script>
  ...
  export default {
    data() {
      return {
        titleName: {name: "精品课程总数"},
        titleName1: {name: ""},
        headerData: {name: "精品课程总数"},
        totalNum: '',
        xData: [],
        yData: [],
        tableList: {
    ...
    mounted: function () {
      http.api({
        ...
        successCallback: function (data) {
          var data1 = getXyData2(data.workTableDate, 'T_SCHOOL_PROVINCE', 'COUNT1');
          ...
          http.api({
            ...
            successCallback: function (data) {
              var data2 = getXyData2(data.workTableDate, 'T_SCHOOL_PROVINCE', 'COUNT1');
              ...
              http.api({
                ...
                successCallback: function (data) {
                  var data3 = getXyData2(data.workTableDate, 'T_SCHOOL_PROVINCE', 'COUNT1');
                  var cityValue = data3.yData[0];
                  this.xData = [defaultValue.stateKey, defaultValue.provincePoint, defaultValue.cityPonit];
                  this.yData = [nationalValue, provinceValue, cityValue];

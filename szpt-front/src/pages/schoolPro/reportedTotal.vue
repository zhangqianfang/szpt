...
export default {
  ...
  methods: {
    ...
    initTotalCount(){
      this._defaultQuery('/schoolPro_reportedSchoolCount', {limit:"100"}, (data)=>{
        this.totalCount = this.japUtils.getOneIntSum(data.workTableDate);
      });
    },
    initChart(){
      this._defaultQuery('/schoolPro_reportedTotal_count', {limit:"100"}, (data)=>{
    ...
    initTable(cityName, page = {pageNo:1,limit:this.page.pageSize}){
      ...
      this._defaultQuery('/schoolPro_getReportedSchoolByCity', option, (data)=>{
